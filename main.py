...
def attack(char_name: str, char_class: str) -> str:
    """Выводит величину урона, нанесённого выбраным персонажем."""
...
def defence(char_name: str, char_class: str) -> str:
    """Выводит величину блокировки от урона выбраным персонажем."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Выводит величину специального умения выбраным персонажем."""
    if char_class == 'warrior':
        return (f'{char_name} '
...
def start_training(char_name: str, char_class: str) -> str:
    """Описывает выбранного персонажа и позволяет управлять его навыками"""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Получает данные для выбора персонажа"""
    approve_choice: str = ''
    char_class: str = ''
